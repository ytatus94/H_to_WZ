...
// Tue May 21 21:29:10 2013 by ROOT version 5.34/05
// from TTree HWWTree_lvqq/HWW lvqq Ntuple
// found on file: ZmumuNp0/group.phys-higgs.299648_025281._00003.HWWSkimmedNTUP_lvqq.root
//////////////////////////////////////////////////////////

#ifndef selectorZmumu_h
#define selectorZmumu_h
...
class selectorZmumu : public TSelector {
public :
   ...
   selectorZmumu(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~selectorZmumu() { }
   ...
   ClassDef(selectorZmumu,0);
};

#endif

#ifdef selectorZmumu_cxx
void selectorZmumu::Init(TTree *tree)
{
